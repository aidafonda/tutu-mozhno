...
Проверяются валидация, построение аргументов из динамической MCP-схемы, разбор SSE, сопоставление вокзалов, доказательная оценка условий, обогащение деталями вагона и честная маркировка demo fallback.
