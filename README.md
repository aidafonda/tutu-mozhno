...
«Туту.Можно» подбирает маршруты по условиям, которые можно подтвердить данными конкретного предложения: отсутствие пересадок, состав пассажиров, багаж, туалет, кондиционер и выбор места. Непроверяемые критерии в форму не попадают.
...
7. Пользователь видит объяснение каждого вывода.
